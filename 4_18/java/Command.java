...
{   
    ...
    public void start()
    {
        ...
        void Create()//1
        {
            ...
            color = scan.nextInt();
            if(this.board.RectangleAdd(x,y,width,height)==0)
            {
        ...
        {
            int i=0;
            ArrayList<Object> List_object = board.source.Update_list();
            for(Object o:List_object)
            {
                i++;
                //正規表現を用いて要素名であるjava.awt.以降の出力
                System.out.println(i+":"+o.toString().split("\\.",3)[2]);
            }
        }
        void Exit()//8
        {
